...
class Blog(models.Model):
    ...
    user = models.ForeignKey('auth.User', verbose_name='Yazar', related_name="blogs", on_delete=models.CASCADE)
    ...
    create_date = models.DateTimeField(auto_now_add=True, editable=False, verbose_name="Oluşturulma Tarihi")
    update_date = models.DateTimeField(auto_now_add=True, editable=False, verbose_name="Güncelleme Tarihi")
